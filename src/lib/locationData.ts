import { IndianStateDistricts } from "./types";

export const stateDistrictsData: IndianStateDistricts = {
  "Assam": [
  ...
  "Andhra Pradesh": [
    ...
    "Srikakulam", "Sri Potti Sriramulu Nellore", "Sri Sathya Sai", "Tirupati", 
  ...
  "Chhattisgarh": [
    ...
    "Raigarh", "Raipur", "Rajnandgaon", "Sukma", "Surajpur", "Surguja", "Sarangarh-Bilaigarh",
  ...
  "Sikkim": [
    "Gangtok", "Gyalshing", "Pakyong", "Soreng", "Mangan", "Namtchi"
  ],
  "Tamil Nadu": [
...
export const qualificationOptions = [
  "8th Pass",
  "10th Pass / Secondary (SSLC)",
  "12th Pass / Higher Secondary (HS)",
  "ITI / Trade Certificate",
  "Diploma",
  "Graduate / Bachelor's Degree (BA / B.Sc / B.Com / B.Tech / etc.)",
  "Post Graduate / Master's Degree (MA / M.Sc / M.Com / M.Tech / MBA / etc.)",
  "Doctorate / PhD",
